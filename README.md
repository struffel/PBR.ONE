...
Check the instructions for [Installation and Hosting](docs/InstallationAndHosting) on how to get started and the [Parameter Reference](docs/ParameterReference) for all possible views and parameters.
